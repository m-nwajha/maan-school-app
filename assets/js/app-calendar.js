$(function() {
	...
	$('#calendar').fullCalendar({
		...
		eventSources: [azhealthyEvents, azReligionEvents, aznonMethodEvents, aztherapeuticEvents , azsocialEvents , azheuristicEvents , azsummerEvents],
	...
	$('.main-nav-calendar-event a').on('click', function(e) {
		...
		if ($(this).hasClass('exclude')) {
			...
			$(this).is(':first-child') ? azCalendar.addEventSource(azhealthyEvents) : '';
			$(this).is(':nth-child(2)') ? azCalendar.addEventSource(azReligionEvents) : '';
			$(this).is(':nth-child(3)') ? azCalendar.addEventSource(aznonMethodEvents) : '';
			$(this).is(':nth-child(4)') ? azCalendar.addEventSource(aztherapeuticEvents) : '';
			$(this).is(':nth-child(5)') ? azCalendar.addEventSource(azsocialEvents) : '';
			$(this).is(':nth-child(6)') ? azCalendar.addEventSource(azheuristicEvents) : '';
			$(this).is(':nth-child(7)') ? azCalendar.addEventSource(azsummerEvents) : '';
